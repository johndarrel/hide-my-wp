                ...
                <div class="card-body">
                    <div class="hmwp_settings_rollback">
                        ...
                        <form method="POST">
                            ...
                            <input type="submit" class="btn rounded-0 btn-default" name="hmwp_rollback" onclick="return confirm('<?php echo esc_js( __( 'Are you sure you want to reset the settings to their initial values?', 'hide-my-wp' ) ); ?>');" value="<?php echo esc_attr__( 'Reset Settings', 'hide-my-wp' ); ?>"/>
                        </form>
                    </div>
                </div>
            </div>
        ...
        <div class="hmwp_col hmwp_col_side px-2 py-0 mr-2">
            <div class="card col-sm-12 m-0 p-0 rounded-0">
                <div class="card-body f-gray-dark text-left">
                    ...
                    <div class="text-info mt-3"><?php /* translators: 1: <strong> opening tag, 2: </strong> closing tag. */ ?><?php echo sprintf( wp_kses_post( __( 'It\'s important to %1$s save your settings every time you change them %2$s. You can use the backup to configure other websites you own.', 'hide-my-wp' ) ), '<strong>', '</strong>' ); ?>
                    </div>
                </div>
            </div>
        </div>
